...
`heart.cost`
```{r, echo = FALSE}
knitr::kable(heart.cost[c(13, 3, 12, 4),], row.names = FALSE)
```
...
`heart.cost`
```{r, echo = FALSE}
knitr::kable(heart.cost[c(2, 13, 3, 12, 4),])
```
...
```{r , fig.margin = TRUE, echo = FALSE, out.width = "20%", fig.align='center', message = FALSE, echo = FALSE}
 knitr::include_graphics(c("images/FFTrees_Logo.jpg"))
```
